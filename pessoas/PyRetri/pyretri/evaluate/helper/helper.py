...
class EvaluateHelper:
    ...
    def do_eval(self, query_result_info: List, gallery_info: List, gallery_fea, query_fea) -> (float, Dict):
        """
        ...
        """
        mAP, recall_at_k = self.evaluator(query_result_info, gallery_info, gallery_fea)

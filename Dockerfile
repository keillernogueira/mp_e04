...
RUN pip install --no-cache --upgrade numpy scipy imageio yacs tqdm seaborn pandas scikit-learn \
    ...
    opencv-python==4.5.5.64 Pillow==8.2.0 PyYAML openpyxl django-mathfilters fpdf django-filter \
    pycocotools thop dlib py7zr validators pafy youtube_dl==2020.12.2 ipywidgets tzdata
